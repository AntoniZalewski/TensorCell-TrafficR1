...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='EfficientColight')
    parser.add_argument("--mod", type=str, default="EfficientColight")
    parser.add_argument("--model", type=str, default="EfficientColight")
    parser.add_argument("--proj_name", type=str, default="LLMTSCS-baseline")
    parser.add_argument("--eightphase", action="store_true", default=False)
    parser.add_argument("--gen", type=int, default=1)
    parser.add_argument("--multi_process", action="store_true", default=True)
    parser.add_argument("--workers", type=int, default=1)
    parser.add_argument("--dataset", type=str, default="newyork_28x7")
    parser.add_argument("--traffic_file", type=str, default="anon_28_7_newyork_real_triple.json")
